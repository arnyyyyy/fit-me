...
class AppColors {
  static const background = Color(0xFFF5EFE7);
  static const cardBackground = Color(0xFFFFFBF6);
  static const title = Color(0xFF4C1A1A);
  static const icon = Color(0xFF5B1F1F);
  static const emptyText = Color(0xFF7C3A3A);
  static const tagBackground = Color(0xFFF4DDD3);
  static const moreTagBackground = Color(0xFFD9B9B4);
  static const tagText = Color(0xFF5B1F1F);
